...
urlpatterns = [
    ...
    # path('calendar/<int:week_id>/offer_buy/', views.offer_buy, name='offer_buy'),
    path('calendar/<int:week_id>/offer_swap/', views.offer_swap, name='offer_swap'),
    # path('calendar/<int:week_id>/offer_sell/', views.offer_sell, name='offer_sell'),
